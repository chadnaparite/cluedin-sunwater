...
{
    public class Sunwater_Command_MeshProcessor : BaseMeshProcessor
    {
        public Sunwater_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          SunwaterConstants.ProviderId;
