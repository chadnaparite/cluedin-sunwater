...
{
    public class DataIngestion : IClassFixture<SunwaterTestFixture>
    {
        private readonly SunwaterTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(SunwaterTestFixture fixture, ITestOutputHelper output)
        {
